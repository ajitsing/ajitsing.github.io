...
- [PostgreSQL MVCC and Autovacuum: The Developer's Guide](/postgresql-mvcc-autovacuum/) - Dead tuples, table bloat, transaction ID wraparound, and tuning autovacuum
