...
*Also see [Replicated Log: How Distributed Systems Stay in Sync](/distributed-systems/replicated-log/), [High Watermark: What's Safe to Read](/distributed-systems/high-watermark/), [Paxos: The Democracy of Distributed Systems](/distributed-systems/paxos/), and [Write-Ahead Log: The Golden Rule of Durable Systems](/distributed-systems/write-ahead-log/).*
