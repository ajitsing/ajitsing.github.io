...
{% include glossary-callout.html terms="replicated-log,linearizability,consensus,raft,paxos,high-watermark,quorum" %}
...
*For more distributed systems patterns, check out [Leader and Followers](/distributed-systems/leader-follower/), [Low Watermark](/distributed-systems/low-watermark/), [Write-Ahead Log](/distributed-systems/write-ahead-log/), [High Watermark](/distributed-systems/high-watermark/), [Hybrid Logical Clock](/distributed-systems/hybrid-clock/), [Majority Quorum](/distributed-systems/majority-quorum/), [Paxos Consensus](/distributed-systems/paxos/), [Heartbeat: Failure Detection](/distributed-systems/heartbeat/), [Lease](/distributed-systems/lease/), [Gossip Dissemination](/distributed-systems/gossip-dissemination/), and [How Kafka Works](/distributed-systems/how-kafka-works/). For a real-world replication system that uses these ideas on top of plain Git, see [How GitHub Stores and Serves Git Repositories](/how-github-stores-and-serves-git-repositories/).*
