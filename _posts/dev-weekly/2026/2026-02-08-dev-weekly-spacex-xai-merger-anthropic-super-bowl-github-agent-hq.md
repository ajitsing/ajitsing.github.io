...
layout: post
seo: true
title: "Dev Weekly Feb 2-8, 2026: SpaceX-xAI $1.25T Merger, GitHub Agent HQ, Docker AI Agent, Big Tech AI Spending"
subtitle: "SpaceX acquires xAI in $1.25 trillion deal. Big Tech announces $600 billion in AI spending, rattling markets. Anthropic buys Super Bowl ads to challenge OpenAI. GitHub opens Agent HQ to Claude and Codex. Docker launches AI Agent. Weekly developer news Feb 2-8, 2026."
date: 2026-02-08
categories: tech-news
permalink: /dev-weekly/2026/feb-2-8/spacex-xai-merger-anthropic-super-bowl-github-agent-hq/
share-img: /assets/img/posts/dev_weekly/tech-news-2-8feb-2026.svg
thumbnail-img: /assets/img/posts/dev_weekly/tech-news-2-8feb-2026.svg
description: "Developer news Feb 2-8, 2026: SpaceX merges with xAI in $1.25T deal. GitHub Agent HQ launches with Claude and Codex support. Docker AI Agent beta released. Big Tech announces $600B AI spending. Anthropic Super Bowl ads challenge OpenAI. Claude Opus 4.6 GA for Copilot. Software development news and AI tools updates."
keywords: "SpaceX xAI merger $1.25 trillion, Big Tech AI spending $600 billion, Anthropic Super Bowl ad OpenAI, GitHub Agent HQ Claude Codex, Docker AI Agent Project Gordon, supply chain attack open source, Claude Opus 4.6 GitHub Copilot, Goldman Sachs Anthropic AI agents, Block layoffs 10 percent, dev weekly February 2026, software developer news"
comments: true
tags: ["dev-weekly", "tech-news", "software-development-news"]
faq:
  - question: "What is the SpaceX-xAI merger?"
    answer: "On February 7, 2026, Elon Musk merged SpaceX with xAI, creating a business worth $1.25 trillion. SpaceX is valued at $1 trillion and xAI at $250 billion. The deal aims to move AI datacentres into space using solar-powered satellites. xAI burned through $13 billion last year and needs SpaceX's cash flow. An IPO is expected in June 2026."
  - question: "How much are Big Tech companies spending on AI?"
    answer: "Alphabet, Amazon, Meta, and Microsoft collectively announced approximately $600 billion in AI capital spending plans on February 6, 2026. This massive spending announcement rattled investors and contributed to market volatility, with concerns about whether these investments will pay off."
  - question: "What is GitHub Agent HQ?"
    answer: "GitHub Agent HQ, announced on February 4, 2026, allows developers to choose between Anthropic's Claude and OpenAI's Codex as their coding agent in GitHub Copilot. This multi-model support is available for Copilot Pro+ and Enterprise subscribers, giving developers more choice in their AI coding assistants."
  - question: "What is Docker AI Agent?"
    answer: "Docker AI Agent, codenamed Project Gordon, launched in beta on February 5, 2026. It embeds an AI assistant directly into Docker Desktop and CLI, helping developers with container-related tasks, Dockerfile generation, and container management through natural language interactions."
---
...
### SpaceX Acquires xAI, Creating $1.25 Trillion Business - [<i class="fas fa-external-link-alt"></i>](https://www.theguardian.com/technology/2026/feb/07/why-has-elon-musk-merged-his-rocket-company-with-his-ai-startup)
...
This is part of Anthropic's push into developer tools. They're competing with OpenAI for the coding market. GitHub is the battleground. For tips on maximizing productivity with AI coding assistants, see our [practical guide](/ai-coding-assistants-guide/).

### Docker AI Agent Beta Launch - [<i class="fas fa-external-link-alt"></i>](https://www.docker.com/blog/beta-launch-docker-ai-agent/)
...
It's in beta, so expect some rough edges. But it's a sign of where Docker is going. AI assistance is becoming standard in developer tools. If you're building AI agents yourself, our [guide to building AI agents](/building-ai-agents/) covers the architecture and patterns that make them work.
...
Dependabot added OIDC authentication support. This improves security for automated dependency updates. OIDC is built on OAuth 2.0 - if you want to understand how OAuth works, check out our [OAuth 2.0 guide](/oauth-2-explained/).
...
Goldman Sachs is a major bank. If they're using AI agents for banking, other banks will follow. This could change how financial services work. To understand how these AI agents work under the hood, see our [guide to building AI agents](/building-ai-agents/).
