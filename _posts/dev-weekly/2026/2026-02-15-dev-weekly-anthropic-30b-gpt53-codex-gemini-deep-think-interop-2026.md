...
layout: post
seo: true
title: "Dev Weekly Feb 9-15: Anthropic Raises $30B, Seedance 2.0 Goes Viral, Google Launches CodeWiki"
subtitle: "Anthropic raises $30B at $380B valuation. Seedance 2.0 goes viral — Disney sends cease-and-desist. Google launches CodeWiki and offers employee exit packages. GPT-5.3 Codex and Gemini 3 Deep Think drop on the same day. Interop 2026 aligns browsers on 20 features. Developer news Feb 9-15, 2026."
date: 2026-02-15
categories: tech-news
permalink: /dev-weekly/2026/feb-9-15/anthropic-30b-gpt53-codex-gemini-deep-think-interop-2026/
share-img: /assets/img/posts/dev_weekly/tech-news-9-15feb-2026.svg
thumbnail-img: /assets/img/posts/dev_weekly/tech-news-9-15feb-2026.svg
description: "Anthropic raises $30B. Seedance 2.0 goes viral — Disney sends cease-and-desist. Google launches CodeWiki and offers exit packages. GPT-5.3 Codex and Gemini Deep Think drop. Dev news Feb 9-15, 2026."
keywords: "Anthropic $30 billion Series G, GPT-5.3 Codex Spark, Gemini 3 Deep Think, ByteDance Seedance 2.0 AI video, Google CodeWiki documentation, Google voluntary exit packages, GLM-5 Zhipu AI, Interop 2026 web standards, GitHub Copilot SDK memory, .NET 11 Preview 1, Disney Seedance cease desist, dev weekly February 2026, software developer news"
comments: true
tags: ["dev-weekly", "tech-news", "software-development-news"]
faq:
  - question: "What is Anthropic's $30 billion Series G raise?"
    answer: "On February 12, 2026, Anthropic announced a $30 billion Series G funding round at a $380 billion post-money valuation. This is one of the largest funding rounds in tech history and shows how competitive the AI race has become. Anthropic, the company behind Claude, is using the money to keep building and competing with OpenAI and Google."
  - question: "What is GPT-5.3-Codex-Spark?"
    answer: "GPT-5.3-Codex-Spark is OpenAI's latest coding-focused model, announced on February 12, 2026. It's designed specifically for software development tasks and represents a significant upgrade to OpenAI's code generation capabilities. The model competes directly with Anthropic's Claude and Google's Gemini for developer mindshare."
  - question: "What is Gemini 3 Deep Think?"
    answer: "Gemini 3 Deep Think is Google's new AI reasoning model, announced on February 12, 2026. It focuses on deep reasoning and complex problem-solving, competing with OpenAI's o-series reasoning models. It's part of Google's push to match and surpass competitors in advanced AI capabilities."
  - question: "What is Interop 2026?"
    answer: "Interop 2026, announced on February 12, 2026, is the fifth year of major browser vendors (Safari, Chrome, Firefox, Edge) working together on cross-browser compatibility. This year covers 20 features including CSS Zoom, WebTransport, View Transitions, anchor positioning, and several CSS enhancements. The goal is to make sure websites work the same across all browsers."
  - question: "What is ByteDance Seedance 2.0?"
    answer: "Seedance 2.0 is ByteDance's AI video generation model released on February 10, 2026. It generates 2K resolution videos with synchronized audio from text prompts or images, and accepts up to 12 reference images. It went viral quickly, but Disney sent ByteDance a cease-and-desist letter on February 14 claiming the model was generating videos using trademarked Disney characters."
  - question: "What is Google CodeWiki?"
    answer: "Google CodeWiki is an AI-powered documentation platform at codewiki.google that uses Gemini to automatically generate and maintain up-to-date documentation for code repositories. On February 11, 2026, Google added Gemini CLI extension support. It currently works with open source repos like React, Flutter, Kubernetes, and Go, with private repository support coming soon."
  - question: "Why is Google offering voluntary exit packages?"
    answer: "On February 11, 2026, Google's chief business officer Philipp Schindler emailed employees in the Global Business Organization (GBO) offering voluntary exit packages. The move is part of Google's broader strategy to restructure as it ramps up AI investment. Employees who aren't 'all in' on their current roles were encouraged to consider the offer."
---
...
### Anthropic Raises $30 Billion at $380B Valuation - [<i class="fas fa-external-link-alt"></i>](https://www.anthropic.com/news/anthropic-raises-30-billion-series-g-funding-380-billion-post-money-valuation)
...
### GPT-5.3-Codex-Spark Launches - [<i class="fas fa-external-link-alt"></i>](https://openai.com/index/introducing-gpt-5-3-codex-spark/)
...
This drops the same week as Gemini 3 Deep Think and right after GLM-5. The timing isn't accidental. Everyone is trying to own the developer tools space. For tips on getting the most out of AI coding tools, check out our [guide on using AI coding assistants effectively](/ai-coding-assistants-guide/).

### Gemini 3 Deep Think Releases - [<i class="fas fa-external-link-alt"></i>](https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-deep-think/)
...
### GLM-5 Targets Complex Engineering and Agentic Tasks - [<i class="fas fa-external-link-alt"></i>](https://z.ai/blog/glm-5)
...
Agentic AI is the buzzword, but GLM-5 is actually trying to deliver on it. If it works well for real engineering tasks, it could find a serious audience. If you're interested in how AI agents work, check out our [guide to building AI agents](/building-ai-agents/).

### ByteDance Seedance 2.0 Goes Viral, Disney Sends Cease-and-Desist - [<i class="fas fa-external-link-alt"></i>](https://www.theverge.com/ai-artificial-intelligence/877931/bytedance-seedance-2-video-generator-ai-launch)
...
On February 14, Disney sent ByteDance a [cease-and-desist letter](https://www.theverge.com/ai-artificial-intelligence/879386/disney-accuses-bytedances-new-ai-video-model-of-infringing-on-its-character), claiming Seedance 2.0 was generating videos featuring trademarked Disney characters. This is the kind of copyright fight that AI video companies have been dreading. If your model can generate Mickey Mouse, you have a legal problem.
...
### .NET 11 Preview 1 and Copilot Testing for .NET GA - [<i class="fas fa-external-link-alt"></i>](https://devblogs.microsoft.com/dotnet/github-copilot-testing-for-dotnet-available-in-visual-studio/)
...
### Interop 2026: Browsers Align on 20 Features - [<i class="fas fa-external-link-alt"></i>](https://webkit.org/blog/17818/announcing-interop-2026/)
...
### Google CodeWiki Gets Gemini CLI Integration - [<i class="fas fa-external-link-alt"></i>](https://codewiki.google)
...
### Ex-GitHub CEO Launches Entire.dev for AI Agents - [<i class="fas fa-external-link-alt"></i>](https://www.thestack.technology/ex-github-ceo-new-startup-entire/#:~:text=Ex%2DGitHub%20CEO%20launches%20new%20dev%20platform%20for%20post%2Dhuman,the%20wave%20of%20AI%20agents.)
...
### AI Agent Published a Hit Piece - [<i class="fas fa-external-link-alt"></i>](https://theshamblog.com/an-ai-agent-published-a-hit-piece-on-me-part-2/)
...
### OpenAI Deleted 'Safely' from Its Mission - [<i class="fas fa-external-link-alt"></i>](https://theconversation.com/openai-has-deleted-the-word-safely-from-its-mission-and-its-new-structure-is-a-test-for-whether-ai-serves-society-or-shareholders-274467)
...
### Google Offers Voluntary Exit Packages as AI Strategy Ramps Up - [<i class="fas fa-external-link-alt"></i>](https://www.businessinsider.com/google-offers-exit-packages-to-some-business-unit-employees-2026-2)
