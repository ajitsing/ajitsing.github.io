...
layout: post
seo: true
title: "Dev Weekly Apr 27-May 3, 2026: Microsoft-OpenAI Split, AWS Bedrock GPT-5.5, Pentagon AI Deals, Apple $111B"
subtitle: "Microsoft and OpenAI end exclusivity, AWS ships GPT-5.5 and Codex on Bedrock, the Pentagon signs eight AI vendors, Cursor opens a TypeScript SDK, and Apple posts its best March quarter ever."
date: 2026-05-03
categories: tech-news
permalink: /dev-weekly/2026/apr-27-may-3/microsoft-openai-restructure-aws-bedrock-pentagon-ai-cursor-sdk-apple-earnings/
share-img: /assets/img/posts/dev_weekly/tech-news-27apr-3may-2026.svg
thumbnail-img: /assets/img/posts/dev_weekly/tech-news-27apr-3may-2026.svg
description: "Dev Weekly roundup for April 27 to May 3, 2026: Microsoft and OpenAI end exclusivity, AWS ships GPT-5.5, Codex, and Bedrock Managed Agents on Amazon Bedrock, and the Pentagon signs eight tech vendors (Microsoft, AWS, Google, OpenAI, Nvidia, SpaceX, Oracle, Reflection AI) for classified IL6 and IL7 AI deployment. Apple posts a record $111.2B Q2 with $57B in iPhone revenue and a $100B buyback. Microsoft Azure grows 40 percent. Anthropic opens Claude Security public beta on Opus 4.7. Cursor ships a TypeScript SDK with sandboxed cloud VMs and subagents. Warp open sources its agentic IDE. Sentry launches the Seer Agent. OpenAI publishes the Symphony coding agent spec. IBM ships Granite 4.1, Nvidia drops Nemotron 3 Nano Omni, xAI launches the Grok 4.3 API, and Hippocratic AI releases Polaris 5.0. GitHub Copilot moves to usage based billing on June 1. Critical security: Linux kernel Copy Fail (CVE-2026-31431), cPanel auth bypass (CVE-2026-41940) exploited since February, Mini Shai-Hulud worm hits SAP npm packages, ShinyHunters breaches at Vimeo, Udemy, and Amtrak. Plus David Silver's Ineffable Intelligence $1.1B seed, Meta acquires Assured Robot Intelligence, Stripe Sessions 2026 launches 288 products, and Scout AI raises $100M for defense."
keywords: "dev weekly April 2026, software developer news April 27 May 3 2026, Microsoft OpenAI partnership restructure non exclusive license revenue share Azure first, AWS OpenAI Bedrock GPT-5.5 Codex Managed Agents limited preview, Pentagon AI eight companies Microsoft Amazon Google OpenAI Nvidia SpaceX Oracle Reflection IL6 IL7 classified Anthropic excluded, Apple Q2 2026 earnings 111 billion iPhone 57 billion services 30.98 billion record, Microsoft Q3 FY26 earnings Azure 40 percent AI 37 billion run rate, Anthropic Claude Security public beta Opus 4.7 vulnerability scanning, Cursor SDK TypeScript public beta sandboxed cloud VMs subagents hooks Composer 2, Warp open source agentic development environment Oz OpenAI founding sponsor, Sentry Seer Agent natural language production debugging Slack, OpenAI Symphony specification coding agents issue tracker WORKFLOW.md Elixir, IBM Granite 4.1 language vision speech embedding guardian 30B 8B 3B 512K context, Nvidia Nemotron 3 Nano Omni multimodal MoE 30B-A3B 256K context, xAI Grok 4.3 API 1M context multimodal video, Hippocratic AI Polaris 5.0 healthcare model 5 trillion parameters, GitHub Copilot usage based billing June 1 2026 token AI Credits, Linux kernel Copy Fail CVE-2026-31431 algif_aead privilege escalation container escape, cPanel WHM CVE-2026-41940 authentication bypass CRLF injection 9.8 CVSS, SAP npm packages compromised Mini Shai-Hulud TeamPCP Bun stealer, Vimeo Udemy Amtrak data breach ShinyHunters Anodot, Meta Assured Robot Intelligence acquisition humanoid robotics Superintelligence Labs, Ineffable Intelligence David Silver 1.1 billion seed Sequoia Lightspeed Nvidia Google, Stripe Sessions 2026 288 launches Agentic Commerce Suite Link agent wallets, Scout AI 100 million Series A defense unmanned warfare, Manifest OS 60 million Series A legal AI, Actively 45 million Series B AI go to market, OpenObserve 10 million Series A observability, Iron Galaxy Redwood Materials layoffs, software developer news weekly roundup"
comments: true
tags: ["dev-weekly", "tech-news", "software-development-news"]
faq:
  - question: "What changed in the Microsoft and OpenAI partnership on April 27, 2026?"
    answer: "Microsoft and OpenAI announced a restructured partnership on April 27, 2026. Microsoft's license to OpenAI IP is now non exclusive through 2032, OpenAI products will still ship first on Azure but can be served from any cloud, and Microsoft will no longer pay OpenAI a revenue share while OpenAI continues paying Microsoft through 2030. The deal ends the legal risk that Microsoft might have sued over OpenAI's exclusive AWS deal for its Frontier agent making service. Microsoft remains OpenAI's primary cloud partner and OpenAI is now formally a public benefit corporation."
  - question: "What did AWS and OpenAI announce on April 28, 2026?"
    answer: "AWS and OpenAI announced an expanded partnership on April 28, 2026 that puts OpenAI frontier models including GPT-5.5, the Codex coding agent, and Amazon Bedrock Managed Agents on Amazon Bedrock in limited preview. Customers can now run OpenAI models with Bedrock controls like IAM, PrivateLink, guardrails, encryption, and CloudTrail. Codex is available through Bedrock via the CLI, desktop app, and VS Code extension. Usage of OpenAI models and Codex on Bedrock can be applied to existing AWS cloud commitments."
  - question: "Which companies signed Pentagon AI deals on May 1, 2026?"
    answer: "The Pentagon announced agreements on May 1, 2026 with eight tech companies to deploy AI on classified networks. The companies are Microsoft, Amazon Web Services, Google, OpenAI, Nvidia, SpaceX, Oracle, and Reflection AI. The systems will run on Impact Level 6 and Impact Level 7 networks for lawful operational use including potential targeting and combat applications. Anthropic was notably excluded after refusing to relax its safety guardrails on autonomous weapons and mass surveillance use cases earlier this year."
  - question: "How did Apple do in Q2 fiscal 2026 earnings on April 30?"
    answer: "Apple reported its best March quarter ever on April 30, 2026 with 111.2 billion dollars in revenue (up 17 percent year over year) and 2.01 dollars in diluted EPS (up 22 percent). iPhone revenue hit a March quarter record of 57 billion dollars, up 22 percent on the iPhone 17 lineup. Services revenue reached an all time high of 30.98 billion dollars. Apple guided Q3 revenue growth of 14 to 17 percent, far above the 9.5 percent Wall Street consensus, and authorized a 100 billion dollar share buyback. Tim Cook said demand was off the charts but supply was constrained by advanced chip nodes from TSMC."
  - question: "What is the Cursor SDK?"
    answer: "Cursor released a TypeScript SDK in public beta on April 29, 2026. It exposes the same runtime, harness, and models that power the Cursor desktop app, CLI, and web interface so you can call Cursor agents from your own code. Agents can run locally or in cloud mode where each agent gets a dedicated sandboxed VM with the repo pre cloned. The SDK includes intelligent context management with codebase indexing and semantic search, MCP server connections, support for subagents, hooks for observing and controlling the agent loop, and token based pricing. Faire, Rippling, Notion, and C3 AI are early production users for CI fixes, internal tools, and customer facing agents."
  - question: "What is Anthropic Claude Security?"
    answer: "Anthropic launched Claude Security in public beta on April 30, 2026 for Claude Enterprise customers. It uses Claude Opus 4.7 to scan codebases for vulnerabilities and propose targeted patches by reasoning about code rather than matching known patterns. Each finding ships with a confidence rating, likely impact, reproduction steps, and a recommended fix. It supports scheduled scans, CSV and Markdown export, and webhook integration with Slack and Jira. Hundreds of organizations tested it during a closed preview that started in February and surfaced bugs that existing tools had missed for years."
  - question: "What happened with the SAP npm supply chain attack on April 29, 2026?"
    answer: "Attackers compromised four official SAP CAP npm packages between 09:55 and 12:14 UTC on April 29, 2026: mbt@1.2.48, @cap-js/db-service@2.10.1, @cap-js/postgres@2.2.2, and @cap-js/sqlite@2.2.2. Together these get around 572,000 weekly downloads. The malicious versions ran a preinstall script that pulled the Bun runtime and a 11.6 MB credential stealer that grabbed GitHub tokens, npm credentials, AWS Azure GCP keys, Kubernetes tokens, and CI runner secrets. The worm self propagated by republishing other packages and dropped repos tagged 'A Mini Shai-Hulud has Appeared' on victim accounts. Researchers attribute the campaign to TeamPCP."
---
...
### Microsoft and OpenAI Restructure Their Partnership - [<i class="fas fa-external-link-alt"></i>](https://blogs.microsoft.com/blog/2026/04/27/the-next-phase-of-the-microsoft-openai-partnership/){:target="_blank"}

On April 27, Microsoft and OpenAI [announced a renegotiated deal](https://techcrunch.com/2026/04/27/openai-ends-microsoft-legal-peril-over-its-50b-amazon-deal/){:target="_blank"} that resolves the legal cloud over OpenAI's $50 billion AWS commitment. The shape of the relationship is now very different.
...
### AWS Lights Up OpenAI Models, Codex, and Managed Agents on Bedrock - [<i class="fas fa-external-link-alt"></i>](https://aws.amazon.com/about-aws/whats-new/2026/04/bedrock-openai-models-codex-managed-agents/){:target="_blank"}
...
The release directly tests the new Microsoft deal. Within a day of the partnership change, GPT-5.5 stopped being an Azure exclusive. Models inherit Bedrock controls like IAM, PrivateLink, guardrails, encryption, and CloudTrail. [The Register called it OpenAI climbing out of Microsoft's bed](https://www.theregister.com/2026/04/28/openai_climbs_into_amazons_bedrock/){:target="_blank"} and into AWS's. For enterprises with AWS commitments, Codex and OpenAI usage now counts toward those contracts. Over 4 million people use Codex weekly so this is not a small SKU.

### Pentagon Signs Eight Big Tech Vendors for Classified AI - [<i class="fas fa-external-link-alt"></i>](https://techcrunch.com/2026/05/01/pentagon-inks-deals-with-nvidia-microsoft-and-aws-to-deploy-ai-on-classified-networks/){:target="_blank"}

On May 1, the Pentagon [announced agreements](https://breakingdefense.com/2026/05/pentagon-clears-7-tech-firms-to-deploy-their-ai-on-its-classified-networks/){:target="_blank"} with eight tech companies to deploy AI on Impact Level 6 and Impact Level 7 classified networks. The companies are Microsoft, Amazon Web Services, Google, OpenAI, Nvidia, SpaceX, Oracle, and Reflection AI.
...
### Apple Posts Best March Quarter Ever - [<i class="fas fa-external-link-alt"></i>](https://www.apple.com/newsroom/2026/04/apple-reports-second-quarter-results/){:target="_blank"}

On April 30, Apple reported [record fiscal Q2 2026 results](https://www.theverge.com/tech/921527/apple-iphone-revenue-q2-2026-earnings){:target="_blank"} with $111.2 billion in revenue, up 17 percent year over year, and $2.01 in diluted EPS, up 22 percent.
...
[Apple guided Q3 revenue growth of 14 to 17 percent](https://www.cnbc.com/2026/05/01/apple-stock-rallies-on-q2-earnings-and-q3-guidance.html){:target="_blank"}, almost double the 9.5 percent Wall Street consensus. The board authorized a $100 billion share buyback. Cook said demand was off the charts but supply was constrained by advanced chip nodes at TSMC where the A19 and A19 Pro are made. Memory price inflation will hit margins in upcoming quarters.

**Wider earnings context:**

Microsoft reported [Q3 FY2026 on April 29](https://www.microsoft.com/en-us/Investor/earnings/FY-2026-Q3/press-release-webcast){:target="_blank"} with $82.9 billion in revenue, Azure up 40 percent, and the AI business at a $37 billion run rate (up 123 percent). Alphabet posted $109.9 billion in revenue with Google Cloud up 63 percent year over year on April 29, the [fastest growth rate Cloud has ever recorded](https://www.cnbc.com/2026/04/29/alphabet-googl-q1-2026-earnings.html){:target="_blank"}. Meta reported $56.31 billion in revenue at a 40.6 percent operating margin. Big Tech earnings season closed strong everywhere AI shows up in the income statement.

### Anthropic Launches Claude Security in Public Beta - [<i class="fas fa-external-link-alt"></i>](https://claude.com/blog/claude-security-public-beta){:target="_blank"}

On April 30, Anthropic [opened Claude Security to public beta](https://thenewstack.io/anthropics-claude-security-beta/){:target="_blank"} for Claude Enterprise customers. The tool runs on Claude Opus 4.7 and scans codebases for vulnerabilities the way a security researcher would, by tracing data flows and reading source rather than matching known signatures.
...
Hundreds of organizations tested Claude Security in a closed preview that started in February. Anthropic [says testers found vulnerabilities in production code](https://siliconangle.com/2026/04/30/anthropic-announces-claude-security-public-beta-find-fix-software-vulnerabilities/){:target="_blank"} that existing tools had missed for years. Major security vendors including CrowdStrike, Microsoft Security, Palo Alto Networks, SentinelOne, TrendAI, and Wiz are integrating Opus 4.7 into their own platforms in parallel.
...
### Warp Open Sources Its Agentic Development Environment - [<i class="fas fa-external-link-alt"></i>](https://www.warp.dev/blog/warp-is-now-open-source){:target="_blank"}

On April 28, Warp [open sourced its core IDE](https://apnews.com/press-release/ez-newswire/warp-open-sources-its-agentic-development-environment-introducing-a-new-model-for-building-software-with-cloud-agents-99584baf8a939d0a1d4d973dddc20760){:target="_blank"} and introduced an Agentic Development Environment (ADE) backed by Oz, its cloud agent orchestration platform. OpenAI is the founding sponsor of the open source repo, with GPT-5.5 powering the Oz workflows. Oz handles the development lifecycle end to end: triage, planning, code, and pull request management. The pitch is that contributors stop writing code and start shaping what gets built while agents handle the implementation. Users can submit feature requests inside the ADE or through GitHub.

### Sentry Launches Seer Agent for Plain English Production Debugging - [<i class="fas fa-external-link-alt"></i>](https://blog.sentry.io/introducing-seer-agent/){:target="_blank"}

Sentry [shipped Seer Agent on April 28](https://sdtimes.com/softwaredev/sentry-launches-seer-agent-enabling-developers-to-investigate-any-production-problem-in-plain-language/){:target="_blank"}. The agent answers questions like "Why is this page slow?" and "What changed before this started?" by reasoning across errors, spans, logs, traces, and code context. It runs across multiple services and repos using distributed tracing data. Seer Agent works in the Sentry UI and inside Slack, where teams can run multiplayer incident response in a thread that becomes a permanent record. It is available in beta to all Sentry users with Seer enabled, included with paid Seer subscriptions at $40 per active contributor per month.

### OpenAI Releases Symphony Spec for Coding Agent Orchestration - [<i class="fas fa-external-link-alt"></i>](https://www.infoworld.com/article/4164173/openais-symphony-spec-pushes-coding-agents-from-prompts-to-orchestration.html){:target="_blank"}

OpenAI released [Symphony](https://github.com/openai/symphony){:target="_blank"}, an open source specification and reference implementation for orchestrating coding agents. Symphony is a long running service that polls an issue tracker like Linear, creates a deterministic per issue workspace, runs an agent session in isolation, monitors CI, and prepares the change for human review. Runtime behavior is loaded from a `WORKFLOW.md` file in the repo so each project can shape what its agents do. Internal teams at OpenAI saw landed pull requests rise 500 percent in the first three weeks because engineers stopped context switching between three to five concurrent Codex sessions. The spec is language agnostic and the reference implementation is in Elixir under Apache 2.0.

### IBM Releases Granite 4.1 Family - [<i class="fas fa-external-link-alt"></i>](https://research.ibm.com/blog/granite-4-1-ai-foundation-models){:target="_blank"}

IBM released [Granite 4.1](https://huggingface.co/blog/ibm-granite/granite-4-1){:target="_blank"} on April 29, the company's most expansive open model release yet. The lineup covers language (3B, 8B, 30B parameters in base and instruct variants), vision (table and chart extraction), speech, embedding, and guardian models for harm detection. The dense decoder only language models support up to 512K tokens of context and emphasize tool calling and instruction following over chain of thought reasoning. Training used about 15 trillion tokens through a five phase pipeline plus supervised fine tuning on roughly 4.1 million curated samples and multi stage RL. The Granite 4.1 8B Instruct model matches or beats the previous 32B MoE on benchmarks despite the simpler architecture. Everything ships under Apache 2.0.

### Nvidia Drops Nemotron 3 Nano Omni - [<i class="fas fa-external-link-alt"></i>](https://developer.nvidia.com/blog/nvidia-nemotron-3-nano-omni-powers-multimodal-agent-reasoning-in-a-single-efficient-open-model/){:target="_blank"}

Nvidia released [Nemotron 3 Nano Omni](https://docs.api.nvidia.com/nim/reference/nvidia-nemotron-3-nano-omni-30b-a3b-reasoning){:target="_blank"} on April 28, a multimodal LLM unifying video, audio, image, and text understanding for enterprise agents. The architecture is a 30B-A3B Mamba2 Transformer hybrid MoE with 31B total parameters and 3.1B active. It accepts video up to 2 minutes, audio up to 1 hour, and images, with a 256K token context window in English. Nvidia says it is best in class on document intelligence and tops MediaPerf for video understanding throughput. Available on Build.Nvidia.com, Hugging Face in BF16, FP8, and NVFP4, and NGC, with vLLM and TensorRT-LLM support across Ampere, Hopper, and Blackwell.

### xAI Launches Grok 4.3 API - [<i class="fas fa-external-link-alt"></i>](https://help.apiyi.com/en/grok-4-3-api-release-may-2026-news-en.html){:target="_blank"}

xAI released the [Grok 4.3 API on April 30](https://www.datastudios.org/post/grok-4-3-characteristics-pricing-benchmarks-context-window-api-access-and-what-changed-from-gr){:target="_blank"} with a 1 million token context window, native video input for the first time, native PDF, XLSX, and PPTX generation, new speech to text and text to speech APIs, and 16 agent parallel scheduling. Pricing dropped to $1.25 per million input tokens and $2.50 per million output, roughly a 40 to 58 percent cut versus Grok 4.20. Output speed lands around 207 to 216 tokens per second. The Artificial Analysis Intelligence Index puts it at 53.2 with 97.7 percent on tau squared Bench tool use and 90.1 percent on GPQA Diamond.

### Hippocratic AI Launches Polaris 5.0 - [<i class="fas fa-external-link-alt"></i>](https://www.prnewswire.com/news-releases/hippocratic-ai-launches-polaris-5-0-the-first-evidence--based-ai-for-healthcare-proven-to-outperform-every-frontier-model-on-critical-medical-tasks-and-safety-302758998.html){:target="_blank"}
...
### Guild.ai Opens Its AI Agent Control Plane - [<i class="fas fa-external-link-alt"></i>](https://markets.businessinsider.com/news/stocks/guild-ai-introduces-the-first-control-plane-for-ai-agents-1036080164){:target="_blank"}
...
### Keeper Security Ships Agent Kit - [<i class="fas fa-external-link-alt"></i>](https://securitybrief.co.uk/story/keeper-security-launches-agent-kit-for-ai-coding-agents){:target="_blank"}
...
### Manifest OS Raises $60M Series A for Legal AI - [<i class="fas fa-external-link-alt"></i>](https://www.pymnts.com/news/investment-tracker/2026/manifest-raises-60-million-in-record-legal-ai-funding-round/){:target="_blank"}
...
### Other Funding Rounds - [<i class="fas fa-external-link-alt"></i>](https://www.businesswire.com/news/home/20260428810008/en/Actively-Raises-%2445M-Series-B-to-Scale-Intelligence-Led-Revenue-Platform){:target="_blank"}

Actively raised $45 million Series B on April 28 (TCV and First Harmonic co led, total $68 million) for an AI go to market platform. [OpenObserve raised $10 million Series A](https://www.businesswire.com/news/home/20260429840147/en/OpenObserve-Raises-%2410-Million-Series-A-to-Accelerate-AI-native-Observability){:target="_blank"} on April 29 (Nexus Venture Partners and Dell Technologies Capital) for AI native observability serving 6,000 organizations.
