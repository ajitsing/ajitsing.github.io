...
layout: post
seo: true
title: "Dev Weekly May 4-10, 2026: Anthropic-SpaceX Compute Deal, Cloudflare Cuts 1,100, AWS Agent Payments, Cursor 3.3"
subtitle: "Anthropic signs SpaceX for the Colossus 1 supercluster, Cloudflare lays off 1,100 in an AI-first pivot, AWS ships Bedrock AgentCore Payments with Coinbase and Stripe, Cursor 3.3 brings PR review and parallel builds, and xAI launches Grok 4.3."
date: 2026-05-10
categories: tech-news
permalink: /dev-weekly/2026/may-4-10/anthropic-spacex-cloudflare-layoffs-cursor-33-aws-agent-payments/
share-img: /assets/img/posts/dev_weekly/tech-news-4-10may-2026.svg
thumbnail-img: /assets/img/posts/dev_weekly/tech-news-4-10may-2026.svg
description: "Dev Weekly roundup for May 4 to 10, 2026. Anthropic signs a SpaceX deal for the entire Colossus 1 data center on May 6, unlocking 220,000 NVIDIA GPUs and 300 megawatts and lifting Claude Code five hour rate limits across Pro, Max, Team, and Enterprise. Cloudflare reports Q1 2026 revenue of 639.8 million dollars on May 7, then announces 1,100 layoffs, a 140 to 150 million dollar restructuring charge, and an agentic AI-first operating model as the stock falls 24 percent. AWS launches Bedrock AgentCore Payments in preview on May 7 with Coinbase and Stripe to let agents pay over the x402 protocol with stablecoins, and the AWS MCP Server reaches general availability on May 6 with the Agent Toolkit for AWS. Cursor 3.3 ships on May 7 with a full PR review experience, Build in Parallel for plans, and Split PRs. OpenAI updates ChatGPT to GPT-5.5 Instant on May 5, ships GPT-Realtime-2, GPT-Realtime-Translate, and GPT-Realtime-Whisper voice models on May 7, scales GPT-5.5-Cyber for cyber defenders, and rolls out Trusted Contact. xAI launches Grok 4.3 on May 6 with a 1 million token context, agentic tool use, and a May 15 deprecation of older Grok models. Google Cloud ships Agent Identity GA, Agent Gateway preview, and 80 Agentic Data Cloud updates on May 6, plus the Gemini API File Search goes multimodal on May 5. Anthropic releases ten financial services agent templates on May 5. Node.js 26.1.0 lands experimental node:ffi on May 7. Next.js 15.5.18 and 16.2.6 patch 13 advisories including CVE-2026-44575 on May 7. React 19.0.6 patches RSC DoS CVE-2026-23870. CISA adds Ivanti EPMM CVE-2026-6973 to the KEV catalog on May 7, BerriAI LiteLLM CVE-2026-42208 on May 8, and Palo Alto PAN-OS CVE-2026-0300 on May 6. Cloudflare ships an emergency WAF release for the Next.js middleware bypass. Snowflake 10.16, Databricks Runtime 18.2 GA, and the Lakeflow Pipelines Editor GA all ship May 4. Kubernetes v1.36 Declarative Validation graduates on May 5. SAP signs deals to acquire Dremio and Prior Labs on May 4. Cisco signs intent to acquire Astrix Security and IREN agrees to acquire Mirantis for 625 million dollars. Google launches the 99 dollar Fitbit Air on May 7. Funding: Blitzy 200 million dollars at 1.4 billion valuation, Corgi 160 million dollars Series B, Quantum Motion 160 million dollars Series C, DeepInfra 107 million dollars Series B, RadixArk 100 million dollars seed for SGLang, Tessera Labs 60 million dollars from a16z."
keywords: "dev weekly May 2026, software developer news May 4 10 2026, Anthropic SpaceX compute deal Colossus 1 220000 NVIDIA GPUs 300 megawatts Claude Code rate limits, Cloudflare Q1 2026 earnings 639.8 million revenue 1100 layoffs agentic AI first restructuring 140 million charge stock 24 percent fall, AWS Bedrock AgentCore Payments preview Coinbase Stripe x402 protocol stablecoin micropayments AI agents, AWS MCP Server general availability Agent Toolkit IAM CloudWatch CloudTrail, Cursor 3.3 PR review experience build in parallel split PRs async subagents quick action pills, OpenAI GPT-5.5 Instant default ChatGPT model 52.5 percent fewer hallucinations medicine law finance, OpenAI GPT Realtime 2 Translate Whisper voice models API 70 languages 13 output, OpenAI GPT-5.5-Cyber Trusted Access for Cyber phishing resistant security defensive cybersecurity, OpenAI Trusted Contact ChatGPT safety mental health emergency contact, xAI Grok 4.3 release 1 million token context agentic tool use 1.25 input 2.50 output deprecation May 15 grok-3 grok-code-fast-1, Google Cloud Agent Identity GA SPIFFE Agent Runtime Agent Gateway Identity Aware Proxy IAP for Agents preview, Google Agentic Data Cloud Knowledge Catalog Cross-Cloud Lakehouse Spanner Omni 80 product updates, Gemini API File Search multimodal page-level citations custom metadata filtering, Anthropic financial services agents Cowork Claude Code plugins pitch builder earnings reviewer GL reconciler, Node.js 26.1.0 experimental node:ffi dynamic library FFI flag buffer crypto HTTP test runner, Next.js 15.5.18 16.2.6 emergency security release CVE-2026-44575 middleware proxy bypass SSRF cache poisoning XSS DoS, React 19.0.6 RSC DoS CVE-2026-23870 type hardening, Svelte May 2026 SvelteKit 2.56.0 remote functions TypeScript 6.0 sv-utils, Kubernetes v1.36 Declarative Validation general availability k8s marker tags Haru, CISA KEV Ivanti EPMM CVE-2026-6973 BerriAI LiteLLM SQL injection CVE-2026-42208 Palo Alto PAN-OS CVE-2026-0300 PAN OS authentication portal, Cloudflare emergency WAF release CVE-2026-44575 Next.js App Router middleware bypass, Cloudflare Workers Stream Bindings IPv6 CIDR Mesh routes, Snowflake 10.16 release notes data quality WITHIN GROUP, Databricks Runtime 18.2 Lakeflow Pipelines Editor GA Outlook GitHub managed ingestion connectors automatic identity management, GitHub Copilot cloud agent organization level secrets variables Agents type, GitHub Copilot CLI enterprise managed plugins public preview Rubber Duck Claude critic, Claude Code v2.1.128 v2.1.133 v2.1.136 worktree settings sandbox configuration MCP server fixes, SAP to acquire Dremio open data lakehouse agentic AI workloads, SAP to acquire Prior Labs Tabular Foundation Models 1 billion euro frontier AI lab Europe, Cisco intent acquire Astrix Security non human identity NHI security agent, IREN acquires Mirantis 625 million OpenStack Kubernetes cloud, Google Fitbit Air launch 99 dollar screenless wearable Google Health Coach, French prosecutors X Musk criminal investigation algorithmic manipulation deepfakes, Arm AGI CPU 2 billion FY27 FY28 sales doubled guidance, Blitzy 200 million 1.4 billion valuation parallel coding agents Northzone, Corgi 160 million Series B TCV insurance startup 1.3 billion valuation, Quantum Motion 160 million Series C silicon chip quantum Kembara, RadixArk 100 million seed SGLang inference engine Accel Spark, DeepInfra 107 million Series B inference platform 5 trillion tokens, Tessera Labs 60 million a16z multi agent ERP, Tekst 11.5 million Series A agentic process intelligence, PHP License retirement 3-clause BSD relicense PHP 9.0 GPL compatible, OpenAI testing ads ChatGPT new ways to buy ads, JetBrains Developer Ecosystem Survey 2026 10th annual, software developer news weekly roundup"
comments: true
tags: ["dev-weekly", "tech-news", "software-development-news"]
faq:
  - question: "What is the Anthropic and SpaceX compute deal announced on May 6, 2026?"
...
### Anthropic Signs SpaceX for the Colossus 1 Supercluster - [<i class="fas fa-external-link-alt"></i>](https://www.anthropic.com/news/higher-limits-spacex){:target="_blank"}

On May 6, Anthropic [announced a partnership with SpaceX](https://www.cnbc.com/2026/05/06/anthropic-spacex-data-center-capacity.html){:target="_blank"} to use all of the compute at SpaceX's Colossus 1 data center in Memphis. The deal unlocks more than 300 megawatts of capacity and over 220,000 NVIDIA GPUs within the month.

**What changed for users on day one:**

Anthropic doubled Claude Code's five hour rate limits for Pro, Max, Team, and seat based Enterprise plans. The peak hours limit reduction for Pro and Max accounts is gone. API rate limits for Claude Opus models went up considerably. All three changes shipped the same day, not at some future date.

**The bigger picture:**

This sits next to Anthropic's other compute commitments: an [up to 5 GW agreement with Amazon](https://www.anthropic.com/news/anthropic-amazon-compute){:target="_blank"}, a 5 GW agreement with Google and Broadcom, a Microsoft and NVIDIA strategic partnership that includes 30 billion dollars of Azure capacity, and a 50 billion dollar US infrastructure investment with Fluidstack. Anthropic also said it has expressed interest in working with SpaceX on multiple gigawatts of orbital AI compute capacity.

**The Musk angle:**

Elon Musk had publicly called Anthropic "evil" not long ago. After the deal, [Musk said on X](https://www.bloomberg.com/news/articles/2026-05-06/anthropic-inks-computing-deal-with-spacex-to-meet-ai-demand){:target="_blank"} that he had spent time with the team and was satisfied they were focused on doing the right thing. The competitive picture inside the AI compute market keeps getting weirder.

### Cloudflare Cuts 1,100 in Agentic AI Pivot - [<i class="fas fa-external-link-alt"></i>](https://www.cloudflare.com/press/press-releases/2026/cloudflare-announces-first-quarter-2026-financial-results/){:target="_blank"}

On May 7, Cloudflare reported Q1 2026 revenue of 639.8 million dollars, up 34 percent year over year and a beat against the 622 million dollar estimate. The same release announced a workforce reduction of approximately [1,100 employees](https://www.businessinsider.com/cloudflare-announces-1100-layoffs-amid-ai-focus-shift-2026-5){:target="_blank"}, around 20 percent of staff.
...
Restructuring charges of 140 to 150 million dollars are expected, with 105 to 110 million in cash and 35 to 40 million in non cash equity costs, mostly hitting Q2 2026. Adjusted EPS came in at 25 cents versus the 23 cent estimate. Full year 2026 revenue is guided to 2.805 to 2.813 billion dollars. Cloudflare stock fell 24 percent on the day despite the earnings beat.

**Why developers should care:**

This is the largest dev-relevant layoff of the week and the clearest statement so far that an AI-native infrastructure vendor will cut headcount even when revenue is growing. Expect more of this framing from other infra companies through the rest of the year.

### AWS Ships Bedrock AgentCore Payments and the AWS MCP Server - [<i class="fas fa-external-link-alt"></i>](https://aws.amazon.com/about-aws/whats-new/2026/04/amazon-bedrock-agentcore-payments-preview/){:target="_blank"}

On May 7, AWS [launched Amazon Bedrock AgentCore Payments in preview](https://www.coindesk.com/business/2026/05/07/amazon-rolls-out-ai-agent-stablecoin-payments-platform-with-coinbase-and-stripe){:target="_blank"} with Coinbase and Stripe. The service lets agents make stablecoin micropayments for APIs, MCP servers, web content, and other paid resources.

**How it works:**

When an agent hits an HTTP 402 from a paid resource, AgentCore handles x402 protocol negotiation, wallet authentication, the stablecoin payment, and proof delivery. The agent's reasoning loop never sees the interruption. Coinbase provides CDP wallet integration and the x402 Bazaar MCP server with more than 10,000 endpoints agents can discover and pay for. Stripe provides Privy wallet infrastructure. Session level spending limits are enforced at the infrastructure layer, and observability flows through standard AgentCore logs, metrics, and traces.

**Where it runs:**

US East (N. Virginia), US West (Oregon), Europe (Frankfurt), and Asia Pacific (Sydney). The current focus is micropayments for digital services. AWS said larger transactions like hotel bookings and travel reservations are on the roadmap.

**The MCP Server GA:**

The day before, on May 6, [AWS announced the AWS MCP Server is generally available](https://aws.amazon.com/about-aws/whats-new/2026/05/aws-mcp-server/){:target="_blank"} as the core component of the [Agent Toolkit for AWS](https://aws.amazon.com/about-aws/whats-new/2026/05/agent-toolkit/){:target="_blank"}. Agents can now call any AWS API through a single tool, including operations that need file uploads or long running execution. Sandboxed Python script execution lets agents run multi step operations against AWS services without touching the local filesystem or shell. Agent Skills replace Agent SOPs with discoverable, on demand guidance to keep context windows lean. There is no per request charge, you pay only for the AWS resources the agents use.
...
Take a PR from creation to merge inside Cursor. The Reviews tab shows inline review threads and top level PR comments. The Commits tab gives a focused view of the commit history. The Changes tab adds a file tree and a changes picker for moving around larger PRs. Reviewer status and pending review banners surface inline, and quick action pills handle the next step.

**Build in Parallel:**

Plans now run faster. Click Build in Parallel and Cursor identifies independent parts of the plan and runs them at the same time using async subagents. Dependent steps stay in order.

**Split PRs:**

A new quick action splits changes into multiple PRs. It uses chat context to find logical slices, defaults to independent PRs when dependencies allow, takes a backup snapshot before splitting, and proposes a split plan for approval.

**Smaller wins worth knowing:**

You can pin commonly used skills as quick action pills. Explore subagent behavior is now configurable in settings, including model choice and a kill switch. The slash multitask command is available in the editor for running async subagents in line. MCP connection behavior is more predictable with explicit stale token cleanup on re-auth.

### xAI Launches Grok 4.3 - [<i class="fas fa-external-link-alt"></i>](https://venturebeat.com/ai/xai-launches-grok-4-3-at-an-aggressively-low-price-and-a-new-fast-powerful-voice-cloning-suite/){:target="_blank"}

On May 6, xAI released Grok 4.3 with built in reasoning as a permanent state, a 1 million token context window, and agentic tool use. Pricing is 1.25 dollars per million input tokens and 2.50 dollars per million output tokens.

**Same day extras:**

Connectors landed for SharePoint, Outlook, OneDrive, Google Workspace, Notion, GitHub, and Linear. The Grok Imagine Quality Mode API opened up. Custom voices and a voice library are available, and there is a new voice cloning suite.

**Migration deadline:**

xAI also published a [May 15, 2026 model retirement notice](https://docs.x.ai/developers/migration/may-15-retirement){:target="_blank"} that retires eight legacy models including grok-4-1-fast-reasoning, grok-4-fast-reasoning, grok-3, grok-code-fast-1, and grok-imagine-image-pro. Anyone calling these endpoints needs to migrate to Grok 4.3 by May 15 or expect failures.
...
### OpenAI Scales Trusted Access for Cyber and Trusted Contact - [<i class="fas fa-external-link-alt"></i>](https://openai.com/index/gpt-5-5-with-trusted-access-for-cyber/){:target="_blank"}

Also on May 7, OpenAI rolled out [GPT-5.5-Cyber in limited preview](https://openai.com/index/gpt-5-5-with-trusted-access-for-cyber/){:target="_blank"} for cybersecurity defenders, behind verified access. Phishing resistant security is required by June 1. The same day, OpenAI [introduced Trusted Contact](https://openai.com/index/introducing-trusted-contact-in-chatgpt/){:target="_blank"}, an optional safety feature that lets adult ChatGPT users nominate an emergency contact for serious mental health and self harm concerns. The notification is intentionally limited and does not include chat transcripts. OpenAI also published [Testing ads in ChatGPT](https://openai.com/index/testing-ads-in-chatgpt/){:target="_blank"} on May 7 and [New ways to buy ChatGPT ads](https://openai.com/index/new-ways-to-buy-chatgpt-ads/){:target="_blank"} on May 5, the first explicit ad surfaces inside ChatGPT itself.

### Google Cloud Ships Agent Identity GA and Agentic Data Cloud Updates - [<i class="fas fa-external-link-alt"></i>](https://cloud.google.com/blog/products/identity-security/whats-new-in-iam-security-governance-and-runtime-defense){:target="_blank"}

On May 6, Google Cloud rolled out a set of IAM updates for the agentic era. Agent Identity is now a first class principal type in IAM, built on the SPIFFE standard and generally available for Agent Runtime, with preview availability in the Gemini Enterprise Agent Platform. Agent Gateway adds policy enforcement for agent to agent and agent to tool connections, with Identity-Aware Proxy (IAP) for Agents in preview. The same day Google introduced its [Agentic Data Cloud](https://www.computerweekly.com/news/366642734/Googles-Agentic-Data-Cloud-to-power-systems-of-action){:target="_blank"} with around 80 product updates, including Knowledge Catalog for metadata management, Cross-Cloud Lakehouse so BigQuery and AI features can run against AWS and Azure data, and Spanner Omni for disconnected edge and on premises deployments.
...
### GitHub Copilot Cloud Agent Gets Org-Level Secrets and Variables - [<i class="fas fa-external-link-alt"></i>](https://github.blog/changelog/2026-05-08-more-flexible-secrets-and-variables-for-copilot-cloud-agent/){:target="_blank"}

On May 8, GitHub gave Copilot cloud agent its own dedicated Agents secrets and variables, sitting next to the existing Actions, Codespaces, and Dependabot types. You can now configure secrets and variables at the organization level for the first time and share them across selected repositories, instead of duplicating per repo Copilot environment configs. There is a separate Agents section in repository settings for repository scoped values. Earlier in the week GitHub also shipped [Enterprise managed plugins for the Copilot CLI in public preview](https://github.blog/changelog/2026-05-06-enterprise-managed-plugins-in-github-copilot-cli-are-now-in-public-preview){:target="_blank"} on May 6, and on May 7 Rubber Duck in the Copilot CLI [added support for more models](https://github.blog/changelog/2026-05-07-rubber-duck-in-github-copilot-cli-now-supports-more-models){:target="_blank"} including Claude as the critic agent. GitHub also posted retirement notices for Grok Code Fast 1 (May 15), GPT-4.1 (June 1), and Claude Sonnet 4 (May 7) in the Copilot model picker.

### Claude Code Ships Three Releases in the Window - [<i class="fas fa-external-link-alt"></i>](https://github.com/anthropics/claude-code/releases/tag/v2.1.136){:target="_blank"}

Claude Code shipped multiple iterations between May 4 and May 9. [v2.1.128 on May 4](https://github.com/anthropics/claude-code/releases/tag/v2.1.128){:target="_blank"} updated the slash model picker, fixed MCP server issues, and rolled in bug fixes. [v2.1.133 on May 7](https://github.com/anthropics/claude-code/releases/tag/v2.1.133){:target="_blank"} added worktree settings, sandbox configuration options, and credential and proxy fixes. v2.1.136 then landed with stability fixes, improved auto mode rules, and further MCP server work. If you are pinning a known good version in CI, the May 7 release is the most stable point in the window.

### Cloudflare Workers Add Stream Bindings - [<i class="fas fa-external-link-alt"></i>](https://developers.cloudflare.com/changelog/post/2026-05-07-stream-workers-binding/){:target="_blank"}

On May 7, Cloudflare added Stream Bindings for Workers. Workers can now interact with the Cloudflare Stream video library programmatically, without the authenticated REST API calls that used to be required. Cloudflare also shipped [IPv6 CIDR routes for Cloudflare Mesh](https://developers.cloudflare.com/changelog/post/2026-05-06-mesh-ipv6-routes/){:target="_blank"} on May 6, enabling IPv6 only and dual stack private networks.

### Snowflake 10.16, Databricks Runtime 18.2, Lakeflow Pipelines GA - [<i class="fas fa-external-link-alt"></i>](https://docs.snowflake.com/en/release-notes/2026/10_16){:target="_blank"}

[Snowflake 10.16](https://docs.snowflake.com/en/release-notes/2026/10_16){:target="_blank"} shipped on May 4. The notable addition is general availability of data quality checks by group, where data metric functions can be associated with tables or views using a `WITHIN GROUP` clause for segment level monitoring. The same day on the [Databricks side](https://docs.databricks.com/aws/en/release-notes/product/2026/may){:target="_blank"}, Databricks Runtime 18.2 hit general availability and the Lakeflow Pipelines Editor reached GA. May 5 added beta managed ingestion connectors for Outlook and GitHub plus automatic identity management for syncing users and groups from identity providers. May 7 shipped faster package installs through `%uv pip` in serverless notebooks.

### Kubernetes v1.36 Declarative Validation Reaches GA - [<i class="fas fa-external-link-alt"></i>](https://kubernetes.io/blog/2026/05/05/kubernetes-v1-36-declarative-validation-ga/){:target="_blank"}
...
### Next.js Emergency Security Release Patches 13 Advisories - [<i class="fas fa-external-link-alt"></i>](https://vercel.com/changelog/next-js-may-2026-security-release){:target="_blank"}

On May 7, Vercel published [Next.js 15.5.18 and 16.2.6](https://github.com/vercel/next.js/releases/tag/v16.2.6){:target="_blank"} as an emergency security release. The patches cover 13 advisories across denial of service, middleware and proxy bypass, server side request forgery, cache poisoning, and cross site scripting. Every user on 13.x, 14.x, 15.x, and 16.x is asked to upgrade. Cloudflare published [a same day emergency WAF rule](https://developers.cloudflare.com/changelog/post/2026-05-07-emergency-waf-release/){:target="_blank"} for CVE-2026-44575, the Next.js middleware bypass affecting App Router applications, as defense in depth ahead of the framework patch landing in production.

### React 19.0.6 Patches RSC Denial of Service - [<i class="fas fa-external-link-alt"></i>](https://github.com/facebook/react/releases/tag/v19.0.6){:target="_blank"}
...
### CISA Adds Three High-Severity CVEs to KEV in Window - [<i class="fas fa-external-link-alt"></i>](https://www.cisa.gov/news-events/alerts/2026/05/07/cisa-adds-one-known-exploited-vulnerability-catalog){:target="_blank"}

CISA added three vulnerabilities to the Known Exploited Vulnerabilities catalog inside the window, all under active exploitation. CVE-2026-6973 in Ivanti EPMM is an authenticated admin remote code execution that landed on May 7 with a three day federal due date. CVE-2026-0300 in Palo Alto PAN-OS is an unauthenticated remote code execution with root in the User-ID Authentication Portal added on May 6 with a May 9 due date. [CVE-2026-42208](https://www.cisa.gov/known-exploited-vulnerabilities-catalog?search_api_fulltext=CVE-2026-42208){:target="_blank"} in BerriAI LiteLLM is a SQL injection added on May 8 with a May 11 due date. The LiteLLM addition is the one most dev teams need to look at, since many self host LiteLLM as a model routing layer in front of paid APIs.

### Cloudflare Ships Emergency WAF Release for CVE-2026-44575 - [<i class="fas fa-external-link-alt"></i>](https://developers.cloudflare.com/changelog/post/2026-05-07-emergency-waf-release/){:target="_blank"}
...
### Cloudflare Q1 Beat With AI-First Layoffs - [<i class="fas fa-external-link-alt"></i>](https://www.cloudflare.com/press/press-releases/2026/cloudflare-announces-first-quarter-2026-financial-results/){:target="_blank"}
...
### SAP Signs to Acquire Dremio and Prior Labs - [<i class="fas fa-external-link-alt"></i>](https://news.sap.com/2026/05/sap-to-acquire-dremio-unify-sap-and-non-sap-data-power-agentic-ai/){:target="_blank"}

On May 4, SAP announced two acquisitions on the same day. The first, [Dremio](https://news.sap.com/2026/05/sap-to-acquire-dremio-unify-sap-and-non-sap-data-power-agentic-ai/){:target="_blank"}, brings an open data lakehouse platform to unify SAP and non-SAP data for agentic AI workloads. The transaction is expected to close in Q3 2026. Terms were not disclosed. The second is [Prior Labs](https://news.sap.com/2026/05/sap-to-acquire-prior-labs-establish-frontier-ai-lab-europe/){:target="_blank"}, a pioneer in Tabular Foundation Models. SAP committed to invest more than 1 billion euros over four years to scale Prior Labs into a frontier AI lab in Europe. Both deals are subject to regulatory approval.

### Cisco Intends to Acquire Astrix Security - [<i class="fas fa-external-link-alt"></i>](https://blogs.cisco.com/news/cisco-announces-intent-to-acquire-astrix-security){:target="_blank"}
...
### IREN to Acquire Mirantis for $625M - [<i class="fas fa-external-link-alt"></i>](https://www.globenewswire.com/news-release/2026/05/05/3287514/0/en/IREN-Announces-Acquisition-of-Mirantis-to-Strengthen-AI-Cloud-Delivery-Capabilities.html){:target="_blank"}
...
### Google Launches the $99 Fitbit Air - [<i class="fas fa-external-link-alt"></i>](https://blog.google/products-and-platforms/devices/fitbit/fitbit-air/){:target="_blank"}

On May 7, Google [launched the Fitbit Air](https://techcrunch.com/2026/05/07/google-unveils-whoop-like-screenless-fitbit-air/){:target="_blank"}, a 99 dollar screenless wearable with Gemini powered Google Health Coach. The device is 25 percent smaller than the Fitbit Luxe and 50 percent smaller than the Inspire 3. Battery lasts up to a week, with a five minute fast charge giving a full day. Available for pre-order now and shipping May 26. Fitbit data moves into the new Google Health app, which is the part developers should track if they ship anything that integrated with Fitbit APIs.

### French Prosecutors Escalate X and Musk Probe to Criminal Investigation - [<i class="fas fa-external-link-alt"></i>](https://www.techmeme.com/260507/p48){:target="_blank"}
...
### Arm Doubles AGI CPU Sales Guidance - [<i class="fas fa-external-link-alt"></i>](https://www.techmeme.com/260507/p2){:target="_blank"}
...
### PHP Retires Its Custom License, Moves to 3-Clause BSD - [<i class="fas fa-external-link-alt"></i>](https://lwn.net/Articles/1071253/){:target="_blank"}

The PHP project formally retired the PHP License 3.01 and the Zend Engine License 2.0, moving everything to the standard 3-clause BSD license. PHP 9.0 ships under the new license. The change makes PHP GPL compatible for the first time and removes a long running headache for distros and downstream packagers. The [retirement announcement](https://lists.opensource.org/pipermail/license-review_lists.opensource.org/2026-May/006087.html){:target="_blank"} went to the OSI license-review list this month.
...
### Quantum Motion Closes $160M Series C - [<i class="fas fa-external-link-alt"></i>](https://www.techmeme.com/260507/p12){:target="_blank"}
...
### Corgi Raises $160M Series B - [<i class="fas fa-external-link-alt"></i>](https://www.prnewswire.com/news-releases/corgi-raises-160-million-series-b-to-continue-expanding-its-full-stack-insurance-platform-into-new-verticals-302764003.html){:target="_blank"}
...
### DeepInfra Closes $107M Series B - [<i class="fas fa-external-link-alt"></i>](https://www.finsmes.com/2026/05/deepinfra-raises-107m-in-series-b-funding.html){:target="_blank"}
...
### RadixArk Launches with $100M Seed for SGLang Infrastructure - [<i class="fas fa-external-link-alt"></i>](https://finance.yahoo.com/sectors/technology/articles/radixark-launches-100-million-seed-130000663.html){:target="_blank"}
...
### Tessera Labs Raises $60M Led by a16z - [<i class="fas fa-external-link-alt"></i>](https://www.finsmes.com/2026/05/tessera-labs-raises-60m-in-funding.html){:target="_blank"}
...
### Tekst Raises $11.5M Series A - [<i class="fas fa-external-link-alt"></i>](https://www.finsmes.com/2026/05/tekst-raises-11-5m-in-series-a-funding.html){:target="_blank"}
