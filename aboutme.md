...
description: "Learn about Ajit Singh, Staff Software Engineer at Agoda with over a decade of experience across Scala, Java, Ruby, Node.js, and Android. Working on scaling Agoda's Content Platform, a contributor to open source, and author of singhajit.com."
seo: true
keywords: "Ajit Singh, Staff Software Engineer, Agoda, ThoughtWorks, Scala, Java, Ruby, Node.js, Android, system design, distributed systems, content platform, backend engineering, open source, software development blog"
...
Open source has been a big part of how I learn and give back. I have contributed to Google's [Espresso](https://developer.android.com/training/testing/espresso) Android testing library by adding view matchers and view actions, and to the Ruby [httparty](https://github.com/jnunemaker/httparty) gem with support for dynamic headers. I also author and maintain [pairing_matrix](https://github.com/ajitsing/pairing_matrix), a Ruby gem that visualizes the pairing matrix of an agile or scrum team from commit history, with support for both GitHub and GitLab. I have also built smaller side projects, including [Sherlock](https://github.com/ajitsing/Sherlock), an Android library that surfaces app crashes as notifications during development.
